...
{
public:
	__forceinline OrthogonalTransform() 
		: m_rotation(kIdentity)
		, m_translation(kZero) 
	{}

	__forceinline OrthogonalTransform(Quaternion rotate) 
		: m_rotation(rotate)
		, m_translation(kZero) 
	{}

	__forceinline OrthogonalTransform(Vector3 translate) 
		: m_rotation(kIdentity)
		, m_translation(translate) 
	{}

	__forceinline OrthogonalTransform(Quaternion rotate, Vector3 translate) 
		: m_rotation(rotate)
		, m_translation(translate) 
	{}

	__forceinline OrthogonalTransform(const Matrix3& mat) 
		: m_rotation(mat)
		, m_translation(kZero) 
	{}

	__forceinline OrthogonalTransform(const Matrix3& mat, Vector3 translate) 
		: m_rotation(mat)
		, m_translation(translate) 
	{}

	__forceinline OrthogonalTransform(EIdentityTag)
		: m_rotation(kIdentity)
		, m_translation(kZero) 
	{}

	__forceinline explicit OrthogonalTransform(const XMMATRIX& mat) 
	{ 
